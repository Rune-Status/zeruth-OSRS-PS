...
public final class class187 {
   ...
   static void method3643(DState var0) {
      boolean var4 = false;
      boolean var5 = false;
      boolean var6 = false;
      boolean var7 = false;
      ...
      if(class115.tt == null) {
         class115.tt = new int[var0.blockSize100k * 100000];
      }
      ...
      while(true) {
         while(var26) {
            byte var1 = method3665(var0);
            if(var1 == 23) {
               return;
            }

            var1 = method3665(var0);
            var1 = method3665(var0);
            var1 = method3665(var0);
            var1 = method3665(var0);
            var1 = method3665(var0);
            ...
            int var40 = method3646(3, var0);
            int var41 = method3646(15, var0);
            ...
            for(var38 = 0; var38 < var40; ++var38) {
               ...
               method3664(var0.field2399[var38], var0.field2384[var38], var0.field2401[var38], var0.field2383[var38], var2, var3, var39);
            ...
            int var52;
            byte var53;
            for(var52 = method3646(var22, var0); var52 > var23[var51]; var52 = var52 << 1 | var53) {
               ++var51;
               var53 = method3645(var0);
            }
            ...
            while(true) {
               while(var46 != var42) {
                  if(var46 != 0 && var46 != 1) {
                     ...
                     ++var0.field2389[var0.seqToUnseq[var1 & 255] & 255];
                     class115.tt[var47] = var0.seqToUnseq[var1 & 255] & 255;
                     ++var47;
                     if(var45 == 0) {
                        ++var43;
                        var45 = 50;
                     ...
                     ++var48;
                     var1 = var0.seqToUnseq[var0.field2394[var0.field2373[0]] & 255];

                     for(var0.field2389[var1 & 255] += var48; var48 > 0; --var48) {
                        class115.tt[var47] = var1 & 255;
                        ++var47;
                     }
                  }
               }
               ...
               for(var36 = 0; var36 < var47; ++var36) {
                  var1 = (byte)(class115.tt[var36] & 255);
                  class115.tt[var0.field2377[var1 & 255]] |= var36 << 8;
                  ++var0.field2377[var1 & 255];
               }

               var0.tPos = class115.tt[var0.field2387] >> 8;
               var0.nblock_used = 0;
               var0.tPos = class115.tt[var0.tPos];
               var0.k0 = (byte)(var0.tPos & 255);
               var0.tPos >>= 8;
               ++var0.nblock_used;
               var0.field2403 = var47;
               method3642(var0);
               if(var0.field2403 + 1 == var0.nblock_used && var0.out_len == 0) {
                  var26 = true;
                  break;
               }
   ...
   static byte method3665(DState var0) {
      return (byte)method3646(8, var0);
   }

   @ObfuscatedName("m")
   static void method3664(int[] var0, int[] var1, int[] var2, byte[] var3, int var4, int var5, int var6) {
      int var7 = 0;
   ...
   static void method3647(DState var0) {
      var0.nInUse = 0;
   ...
   static byte method3645(DState var0) {
      return (byte)method3646(1, var0);
   }
   ...
   static int method3646(int var0, DState var1) {
   ...
   @ObfuscatedName("g")
   public static int method3641(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      DState var5 = state;
      synchronized(state) {
         state.strm = var2;
         state.next_in = var4;
