...
public final class SpritePixels extends Rasterizer2D implements RSSpritePixels {
    ...
    @ObfuscatedName("f")
    public void method2255(int var1, int var2, int var3, int var4) {
        if (var3 > 0 && var4 > 0) {
            int var5 = this.width;
            ...
            var13 = var1 + var2 * graphicsPixelsWidth;
            int var14 = graphicsPixelsWidth - var3;
            ...
            if (var2 < drawingAreaTop) {
                ...
                var4 -= var15;
                var13 += var15 * graphicsPixelsWidth;
                var8 += var12 * var15;
            }
            ...
            method2333(graphicsPixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
        }
    }
    ...
    public void method2253(int var1, int var2) {
        var1 += this.offsetX;
        var2 += this.offsetY;
        int var3 = var1 + var2 * graphicsPixelsWidth;
        int var4 = 0;
        int var5 = this.height;
        int var6 = this.width;
        int var7 = graphicsPixelsWidth - var6;
        int var8 = 0;
        int var9;
        if (var2 < drawingAreaTop) {
        ...
        if (var6 > 0 && var5 > 0) {
            method2254(graphicsPixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
        }
    }
    ...
    public SpritePixels method2243() {
    ...
    public void method2244() {
        method440(this.pixels, this.width, this.height);
    }
    ...
    public void method2275(int var1, int var2, int var3) {
        var1 += this.offsetX;
        var2 += this.offsetY;
        int var4 = var1 + var2 * graphicsPixelsWidth;
        int var5 = 0;
        int var6 = this.height;
        int var7 = this.width;
        int var8 = graphicsPixelsWidth - var7;
        int var9 = 0;
        int var10;
        if (var2 < drawingAreaTop) {
            ...
            var2 = drawingAreaTop;
            var5 += var10 * var7;
            var4 += var10 * graphicsPixelsWidth;
        }

        if (var6 + var2 > drawingAreaRight) {
            var6 -= var6 + var2 - drawingAreaRight;
        }
        ...
        if (var7 + var1 > drawingAreaBottom) {
            var10 = var7 + var1 - drawingAreaBottom;
            var7 -= var10;
            var9 += var10;
            var8 += var10;
        }
        ...
        if (var7 > 0 && var6 > 0) {
            if (var3 == 256) {
                method2264(0, 0, 0, graphicsPixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                method2265(0, 0, 0, graphicsPixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3);
            }
    ...
    @ObfuscatedName("m")
    public void method2249(int var1) {
    ...
    @ObfuscatedName("ag")
    public void method2256(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
        try {
            int var10 = -var3 / 2;
            int var11 = -var4 / 2;
            ...
            int var16 = var1 + var2 * graphicsPixelsWidth;
            ...
            for (var2 = 0; var2 < var4; ++var2) {
                ...
                for (var1 = -var3; var1 < 0; ++var1) {
                    ...
                    if (var20 != 0) {
                        graphicsPixels[var17++] = var20 | -16777216;
                    } else {
                        ++var17;
                    }
    ...
    @ObfuscatedName("aj")
    public void method2269(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
        try {
            int var11 = -var3 / 2;
            int var12 = -var4 / 2;
            ...
            int var17 = var1 + var2 * graphicsPixelsWidth;
            ...
            for (var2 = 0; var2 < var4; ++var2) {
                ...
                for (var1 = -var10[var2]; var1 < 0; ++var1) {
                    graphicsPixels[var19++] = this.pixels[this.width * (var21 >> 16) + (var20 >> 16)] | -16777216;
                    var20 += var14;
                    var21 -= var13;
                }
    ...
    @ObfuscatedName("aw")
    public void method2334(int var1, int var2, int var3, int var4, int var5) {
        if (var3 > 0 && var4 > 0) {
            int var6 = this.width;
            ...
            var14 = var1 + var2 * graphicsPixelsWidth;
            int var15 = graphicsPixelsWidth - var3;
            if (var2 + var4 > drawingAreaRight) {
                var4 -= var2 + var4 - drawingAreaRight;
            }
            ...
            int var16;
            if (var2 < drawingAreaTop) {
                var16 = drawingAreaTop - var2;
                var4 -= var16;
                var14 += var16 * graphicsPixelsWidth;
                var9 += var13 * var16;
            }

            if (var3 + var1 > drawingAreaBottom) {
                var16 = var3 + var1 - drawingAreaBottom;
                var3 -= var16;
                var15 += var16;
            }

            if (var1 < draw_region_x) {
                var16 = draw_region_x - var1;
                var3 -= var16;
                var14 += var16;
                var8 += var12 * var16;
                var15 += var16;
            ...
            if (var5 == 256) {
                method2349(0, 0, 0, var8, this.pixels, graphicsPixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
            } else {
                method2328(0, 0, 0, var8, this.pixels, graphicsPixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
            }
    ...
    @ObfuscatedName("t")
    public void method2288(int var1, int var2, int var3, int var4) {
        if (var3 == 256) {
            this.method2253(var1, var2);
        } else {
            var1 += this.offsetX;
            var2 += this.offsetY;
            int var5 = var1 + var2 * graphicsPixelsWidth;
            int var6 = 0;
            int var7 = this.height;
            int var8 = this.width;
            int var9 = graphicsPixelsWidth - var8;
            int var10 = 0;
            int var11;
            if (var2 < drawingAreaTop) {
                ...
                var2 = drawingAreaTop;
                var6 += var11 * var8;
                var5 += var11 * graphicsPixelsWidth;
            }

            if (var7 + var2 > drawingAreaRight) {
                var7 -= var7 + var2 - drawingAreaRight;
            }
            ...
            if (var8 + var1 > drawingAreaBottom) {
                var11 = var8 + var1 - drawingAreaBottom;
                var8 -= var11;
                var10 += var11;
                var9 += var11;
            }
            ...
            if (var8 > 0 && var7 > 0) {
                method2258(graphicsPixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
            }
        }
    }
    ...
    @ObfuscatedName("at")
    public void method2263(int var1, int var2, int var3, int var4) {
        if (var3 <= this.maxWidth && var4 <= this.maxHeight) {
            ...
            if (var5 < draw_region_x) {
                var5 = draw_region_x;
            }

            if (var6 > drawingAreaBottom) {
                var6 = drawingAreaBottom;
            }

            if (var7 < drawingAreaTop) {
                var7 = drawingAreaTop;
            }

            if (var8 > drawingAreaRight) {
                var8 = drawingAreaRight;
            }

            if (var5 < var6 && var7 < var8) {
                int var9 = var5 + var7 * graphicsPixelsWidth;
                int var10 = graphicsPixelsWidth - (var6 - var5);
                if (var9 < graphicsPixels.length) {
                        ...
                        for (int var12 = var5; var12 < var6; ++var12) {
                            ...
                            if (var19 != 0) {
                                ...
                                if (var27 >= var19) {
                                    ...
                                    graphicsPixels[var9] = var28 | -16777216;
                                }
    ...
    @ObfuscatedName("ar")
    void method2272(int var1, int var2, int var3, int var4, int var5, int var6) {
        if (var6 != 0) {
            var1 -= this.offsetX << 4;
            var2 -= this.offsetY << 4;
            ...
            var21 >>= 4;
            var22 = var22 + 15 >> 4;
            if (var19 < draw_region_x) {
                var19 = draw_region_x;
            }

            if (var20 > drawingAreaBottom) {
                var20 = drawingAreaBottom;
            }

            if (var21 < drawingAreaTop) {
                var21 = drawingAreaTop;
            }

            if (var22 > drawingAreaRight) {
                var22 = drawingAreaRight;
            }
            ...
            if (var20 < 0) {
                var22 = var21 - var22;
                if (var22 < 0) {
                    int var23 = var19 + var21 * graphicsPixelsWidth;
                    ...
                    if (var27 == 0) {
                        if (var26 == 0) {
                            for (var33 = var22; var33 < 0; var23 += graphicsPixelsWidth) {
                                var34 = var23;
                                var35 = var30;
                                var36 = var31;
                                var37 = var20;
                                if (var30 >= 0 && var31 >= 0 && var30 - (this.width << 12) < 0 && var31 - (this.height << 12) < 0) {
                                    for (; var37 < 0; ++var37) {
                                        ...
                                        if (var38 != 0) {
                                            graphicsPixels[var34++] = var38 | -16777216;
                                        } else {
                                            ++var34;
                                        }
                                    }
    ...
    @ObfuscatedName("j")
    public void method2273(int var1, int var2) {
        var1 += this.offsetX;
        var2 += this.offsetY;
        int var3 = var1 + var2 * graphicsPixelsWidth;
        int var4 = 0;
        ...
        if (var6 > 0 && var5 > 0) {
            method2301(graphicsPixels, this.pixels, var4, var3, var6, var5, var7, var8);
        }
    }

    @ObfuscatedName("s")
    public void method2259(int var1, int var2, int var3) {
        var1 += this.offsetX;
        var2 += this.offsetY;
        int var4 = var1 + var2 * graphicsPixelsWidth;
        int var5 = 0;
        ...
        if (var7 > 0 && var6 > 0) {
            method2260(graphicsPixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
        }
    }

    @ObfuscatedName("az")
    public void method2268(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
        ...
        int var13 = var3 + var11 + (var9 + var2 + var4) * graphicsPixelsWidth + var1;
        int var14 = var9 + var2;
        ...
        for (int var15 = var9; var15 < var10; ++var15) {
            ...
            for (int var20 = var19; var20 < var12; ++var20) {
                ...
                if (var21 != 0) {
                    graphicsPixels[var18++] = var21 | -16777216;
                } else {
                    ++var18;
                }
            }

            var13 += graphicsPixelsWidth;
        }

    }

    @ObfuscatedName("u")
    public void method2261(int var1, int var2, int var3, int var4, int var5) {
        if (var3 > 0 && var4 > 0) {
            int var6 = this.width;
            int var7 = this.height;
            int var8 = 0;
            ...
            method2262(graphicsPixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
        }
    }

    @ObfuscatedName("ab")
    public void method2271(int var1, int var2, int var3, int var4) {
        this.method2272(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
    }
    ...
    public SpritePixels method2242() {
    ...
    @ObfuscatedName("ae")
    static void method2349(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
    ...
    @ObfuscatedName("k")
    static void method2258(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
        int var11 = 256 - var9;
    ...
    @ObfuscatedName("x")
    static void method2301(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
    ...
    @ObfuscatedName("o")
    static void method2262(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
        int var13 = 256 - var12;
        int var14 = var3;
    ...
    @ObfuscatedName("a")
    static void method2333(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
        int var12 = var3;
    ...
    @ObfuscatedName("an")
    static void method2264(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
    ...
    @ObfuscatedName("y")
    static void method2260(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
        int var10 = 256 - var9;
    ...
    @ObfuscatedName("ax")
    static void method2265(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
        for (var8 = -var10; var8 < 0; ++var8) {
            for (var6 = -var9; var6 < 0; ++var6) {
                var0 = var4[var5++];
                if (var0 != 0) {
    ...
    @ObfuscatedName("ac")
    static void method2328(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
    ...
    @ObfuscatedName("h")
    static void method2254(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
        int var9 = -(var5 >> 2);
        var5 = -(var5 & 3);
