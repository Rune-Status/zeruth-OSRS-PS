...
@ObfuscatedName("ld")
public class class97 implements class313 {
   @ObfuscatedName("g")
   @ObfuscatedSignature(
      signature = "(B)Llr;",
      garbageValue = "11"
   )
   public MachineInfo vmethod5955() {
      byte var1;
      if(MapIcon.osName.startsWith("win")) {
         var1 = 1;
      } else if(MapIcon.osName.startsWith("mac")) {
         var1 = 2;
      } else if(MapIcon.osName.startsWith("linux")) {
         var1 = 3;
      } else {
         var1 = 4;
      }
