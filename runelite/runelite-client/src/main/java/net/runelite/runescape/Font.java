...
public final class Font extends FontTypeFace {
    ...
    @ObfuscatedName("r")
    final void vmethod2356(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        if (var4 > 0 && var5 > 0) {
            FontTypeFace.method1798(Rasterizer2D.graphicsPixels, var1, var6, var11, var8, var4, var5, var9, var10, var7);
        }
    }

    @ObfuscatedName("g")
    final void vmethod2360(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var4 > 0 && var5 > 0) {
            FontTypeFace.method1796(Rasterizer2D.graphicsPixels, var1, var6, var10, var7, var4, var5, var8, var9);
        }
    }
}
