...
public class ModeratorZone extends MapZone {
	...
	player.getTeleporter().send(ServerConstants.getHomeLocation(), TeleportManager.TeleportType.NORMAL);
    }
	...
	player.getTeleporter().send(center, TeleportManager.TeleportType.NORMAL);
    }
