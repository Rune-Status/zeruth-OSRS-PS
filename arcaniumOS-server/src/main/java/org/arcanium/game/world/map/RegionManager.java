...
public final class RegionManager {
    ...
    public static void move(Entity entity) {
        ...
        int regionId = (entity.getLocation().getRegionX()) << 8 | (entity.getLocation().getRegionY());
        ...
        for (int regionX = (entity.getLocation().getRegionX()) - 1; regionX <= (entity.getLocation().getRegionX()) + 1; regionX++) {
            for (int regionY = (entity.getLocation().getRegionY()) - 1; regionY <= (entity.getLocation().getRegionY()) + 1; regionY++) {
    ...
    public static Deque<Player> getViewportPlayers(Location l) {
        ...
        for (int regionX = (l.getChunkX() - 6) >> 3; regionX <= (l.getChunkX() + 6) >> 3; regionX++) {
            for (int regionY = (l.getChunkY() - 6) >> 3; regionY <= (l.getChunkY() + 6) >> 3; regionY++) {
