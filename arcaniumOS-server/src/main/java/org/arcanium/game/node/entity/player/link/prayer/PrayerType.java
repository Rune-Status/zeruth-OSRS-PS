package org.arcanium.game.node.entity.player.link.prayer;

import org.arcanium.game.content.skill.SkillBonus;
...
public enum PrayerType {
    ...
    THICK_SKIN(1, 12, 83, 5, PrayerCategory.BABY_BLUE, 2690, new SkillBonus(Skills.DEFENCE, 0.05)),
    BURST_OF_STRENGTH(4, 12, 84, 6, PrayerCategory.GREEN, 2688, new SkillBonus(Skills.STRENGTH, 0.05)),
    CLARITY_OF_THOUGHT(7, 12, 85, 7, PrayerCategory.PINK, 2664, new SkillBonus(Skills.ATTACK, 0.05)),
    SHARP_EYE(8, 12, 862, 23, PrayerCategory.LIME_GREEN, 2685, new SkillBonus(Skills.RANGE, 0.05)),
    MYSTIC_WILL(9, 12, 863, 24, PrayerCategory.LIME_GREEN, 2670, new SkillBonus(Skills.MAGIC, 0.05)),
    ROCK_SKIN(10, 6, 86, 8, PrayerCategory.BABY_BLUE, 2684, new SkillBonus(Skills.DEFENCE, 0.1)),
    SUPERHUMAN_STRENGTH(13, 6, 87, 9, PrayerCategory.GREEN, 2689, new SkillBonus(Skills.STRENGTH, 0.1)),
    IMPROVED_REFLEXES(16, 6, 88, 10, PrayerCategory.PINK, 2662, new SkillBonus(Skills.ATTACK, 0.1)),
    RAPID_RESTORE(19, 26, 89, 11, PrayerCategory.PURPLE, 2679),
    RAPID_HEAL(22, 18, 90, 12, PrayerCategory.PURPLE, 2678),
    PROTECT_ITEMS(25, 18, 91, 13, PrayerCategory.DARK_GREEN, 1982),
    HAWK_EYE(26, 6, 864, 25, PrayerCategory.LIME_GREEN, 2666, new SkillBonus(Skills.RANGE, 0.1)),
    MYSTIC_LORE(27, 6, 865, 26, PrayerCategory.LIME_GREEN, 2668, new SkillBonus(Skills.MAGIC, 0.1)),
    STEEL_SKIN(28, 3, 92, 14, PrayerCategory.BABY_BLUE, 2687, new SkillBonus(Skills.DEFENCE, 0.15)),
    ULTIMATE_STRENGTH(31, 3, 93, 15, PrayerCategory.GREEN, 2691, new SkillBonus(Skills.STRENGTH, 0.15)),
    INCREDIBLE_REFLEXES(34, 3, 94, 16, PrayerCategory.PINK, 2667, new SkillBonus(Skills.ATTACK, 0.15)),
    PROTECT_FROM_MAGIC(37, 3, 95, 17, PrayerCategory.LIGHT_BROWN, 2675),
    PROTECT_FROM_MISSILES(40, 3, 96, 18, PrayerCategory.LIGHT_BROWN, 2677),
    PROTECT_FROM_MELEE(43, 4, 97, 19, PrayerCategory.LIGHT_BROWN, 2676),
    EAGLE_EYE(44, 3, 866, 27, PrayerCategory.LIME_GREEN, 2665, new SkillBonus(Skills.RANGE, 0.15)),
    MYSTIC_MIGHT(45, 3, 867, 28, PrayerCategory.LIME_GREEN, 2669, new SkillBonus(Skills.MAGIC, 0.15)),
    RETRIBUTION(46, 12, 98, 20, PrayerCategory.LIGHT_BROWN, PrayerCategory.MAGENTA, new Audio(2682)),
    REDEMPTION(49, 6, 99, 21, PrayerCategory.LIGHT_BROWN, PrayerCategory.MAGENTA, new Audio(2680)),
    SMITE(52, 2, 100, 22, PrayerCategory.LIGHT_BROWN, PrayerCategory.MAGENTA, new Audio(2686)),
    //TODO Remove below
     ...
     */
    private final static Object[][] ICON_CACHE = new Object[][]{{REDEMPTION, 5}, {RETRIBUTION, 3}, {SMITE, 4}, {PROTECT_FROM_MAGIC, 2, 10}, {PROTECT_FROM_MELEE, 0, 8}, {PROTECT_FROM_MISSILES, 1, 9}, {PROTECT_FROM_MELEE, 8, PROTECT_FROM_MISSILES, 9, PROTECT_FROM_MAGIC, 10}};
    ...
    public boolean toggle(final Player player, final boolean on) {
        player.getConfigManager().sendVarp(getConfig(), on ? 1 : 0);
        if (on) {
            flag(player, this);
