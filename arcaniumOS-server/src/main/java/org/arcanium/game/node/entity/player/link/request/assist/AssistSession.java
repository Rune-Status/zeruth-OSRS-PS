package org.arcanium.game.node.entity.player.link.request.assist;
...
import org.arcanium.game.node.entity.player.link.request.RequestModule;
...
public final class AssistSession extends Pulse implements RequestModule {
	...
	player.getConfigManager().sendVarp(1087, value);
	player.getConfigManager().sendVarp(1088, (int) totalXp * 10);
    }
