...
public final class DefaultCombatSpell extends CombatSpell {
    ...
    public DefaultCombatSpell(NPC npc) {
        super(SpellType.BOLT, SpellBookManager.SpellBook.MODERN, 0, 0.0, -1, -1, npc.getDefinition().getCombatAnimations()[2], npc.getDefinition().getCombatGraphics()[0], null, npc.getDefinition().getCombatGraphics()[2]);
