...
import org.arcanium.game.node.entity.player.link.ConfigurationManager.Configuration;
...
public final class Settings {
    ...
    public void update() {
        ...
        player.getConfigManager().sendVarp(1054, clanChatSetting);
        player.getConfigManager().sendVarp(1055, assistSetting);
        player.getConfigManager().sendVarp(300, specialEnergy * 10);
        player.getConfigManager().sendVarp(43, attackStyleIndex);
    ...
    public void setSpecialToggled(boolean enable) {
        ...
        player.getConfigManager().sendVarp(301, specialToggled ? 1 : 0);
    }
    ...
    public void toggleRetaliating() {
        ...
        player.getConfigManager().sendVarp(172, !player.getProperties().isRetaliating() ? 1 : 0);
    }
    ...
    public void toggleMouseButton() {
        ...
        player.getConfigManager().sendVarp(170, singleMouseButton ? 1 : 0);
    }
    ...
    public void toggleChatEffects() {
        ...
        player.getConfigManager().sendVarp(171, disableChatEffects ? 1 : 0);
    }
    ...
    public void toggleSplitPrivateChat() {
        ...
        player.getConfigManager().sendVarp(287, splitPrivateChat ? 1 : 0);
    }
    ...
    public void toggleAcceptAid() {
        acceptAid = !acceptAid;
        player.getConfigManager().sendVarp(427, acceptAid ? 1 : 0);
    }
    ...
    public void setRunToggled(boolean enabled) {
        runToggled = enabled;
        player.getConfigManager().sendVarp(173, runToggled ? 1 : 0);
    }
    ...
    public void setBrightness(int brightness) {
        ...
        player.getConfigManager().sendVarp(166, brightness + 1);
    }
    ...
    public void setMusicVolume(int musicVolume) {
        ...
        player.getConfigManager().sendVarp(168, musicVolume);
    }
    ...
    public void setSoundEffectVolume(int soundEffectVolume) {
        ...
        player.getConfigManager().sendVarp(169, soundEffectVolume);
    }
    ...
    public void setAreaSoundVolume(int areaSoundVolume) {
        ...
        player.getConfigManager().sendVarp(872, areaSoundVolume);
    }
