package org.arcanium.game.node.entity.player.link.music;
...
public final class MusicPlayer implements SavingModule {
    ...
    public void init() {
        refreshList();
        player.getConfigManager().sendVarp(19, looping ? 1 : 0);
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < CONFIG_IDS.length; i++) {
            player.getConfigManager().sendVarp(CONFIG_IDS[i], values[i]);
        }
    }
