            ...
            if (object instanceof Integer) {
                switch (name) {
                    ...
                    case DEFENCE_ANIMATION:
                        configs.put(name, new Animation((int) object, Animator.Priority.HIGH));
                        break;
                    case COMBAT_STYLE:
                    case PROTECT_STYLE:
                ...
                System.err.println("Error! Unhandled object type " + object.getClass().getSimpleName() + ", value = " + object + ", name =" + name);
            }
        }
    }
