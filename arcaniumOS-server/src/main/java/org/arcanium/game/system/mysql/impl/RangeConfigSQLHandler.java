...
public class RangeConfigSQLHandler extends SQLEntryHandler<Object> {
    ...
    public void parse() throws SQLException {
        ...
        statement = connection.prepareStatement("SELECT * FROM ammo_configs");
    ...
    private void parseWeapon(int itemId, ResultSet set) throws SQLException {
        ...
        RangeWeapon weapon = new RangeWeapon(itemId, new Animation(set.getInt("animation"), Animator.Priority.HIGH), ItemDefinition.forId(itemId).getConfiguration(ItemConfigSQLHandler.ATTACK_SPEED, 4), set.getInt("ammo_slot"), set.getInt("weapon_type"), set.getBoolean("drop_ammo"), ammunition);
