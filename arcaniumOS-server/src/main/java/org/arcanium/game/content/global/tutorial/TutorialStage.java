...
import org.arcanium.game.node.entity.player.link.HintIconManager;
...
public enum TutorialStage {
	...
	public void run(final Player player) {
		...
		player.getConfigManager().sendVarp(1021, 12);
	    } else {
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(406, 2);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 4);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 2);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(406, 3);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(406, 4);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 14);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(406, 6);
	    player.getConfigManager().sendVarp(1021, 13);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(0, 2, 4, 5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 7);
	    }
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 0);
	    player.getInterfaceManager().openTab(new Component(274));
	    player.getConfigManager().sendVarp(406, 8);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(0, 4, 5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 9);
	    } else {
		removeHintIcon(player);
	    }
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(0, 4, 5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 10);
	    } else {
		removeHintIcon(player);
	    }
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 5);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(406, 10);
	    player.getConfigManager().sendVarp(1021, 1);
	...
	public void run(final Player player) {
		...
		player.getConfigManager().sendVarp(406, 11);
	    }
	    player.getConfigManager().sendVarp(406, 11);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 12);
	    }
	    player.getConfigManager().sendVarp(406, 12);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 14);
	    } else {
		removeHintIcon(player);
	    }
	    player.getConfigManager().sendVarp(406, 14);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(5, 6, 7, 8, 9, 10);
		player.getConfigManager().sendVarp(406, 16);
	    } else {
		removeHintIcon(player);
	    }
	    player.getConfigManager().sendVarp(406, 16);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 6);
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 9);
	    removeHintIcon(player);
	...
	public void run(final Player player) {
	    ...
	    player.getInterfaceManager().openTab(new Component(589));
	    player.getConfigManager().sendVarp(1021, 10);
	...
	public void run(final Player player) {
	    if (login) {
		player.getInterfaceManager().removeTabs(6, 7);
		player.getConfigManager().sendVarp(406, 17);
	    } else {
		removeHintIcon(player);
	    }
	...
	public void run(final Player player) {
	    ...
	    player.getConfigManager().sendVarp(1021, 7);
	...
	public void run(final Player player) {
	    if (login) {
		player.getConfigManager().sendVarp(406, 19);
	    }
	...
	public void run(final Player player) {
	    if (login) {
		player.getConfigManager().sendVarp(406, 20);
	    }
