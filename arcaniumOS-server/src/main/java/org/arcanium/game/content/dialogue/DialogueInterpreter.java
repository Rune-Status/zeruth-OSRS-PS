...
import org.arcanium.game.system.script.context.*;
...
public final class DialogueInterpreter {
    ...
    public Component sendDestroyItem(int id, String message) {
        ...
        PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, 94, 93, 93, new Item[]{new Item(id)}, 1, false));
