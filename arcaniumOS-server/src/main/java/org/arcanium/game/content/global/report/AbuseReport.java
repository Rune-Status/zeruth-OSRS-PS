package org.arcanium.game.content.global.report;

import org.arcanium.game.node.entity.player.Player;
import org.arcanium.game.world.repository.Repository;
import org.arcanium.net.packet.client.ChatPacket;
...
public final class AbuseReport {
	...
	final List<ChatPacket.ChatEntryLogger.ChatEntry> records = ChatPacket.getChatEntryLogger().getOrganized(player, target);
	StringBuilder b = new StringBuilder();
	for (ChatPacket.ChatEntryLogger.ChatEntry e : records) {
