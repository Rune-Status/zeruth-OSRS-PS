...
public enum Bones {
    ...
    MONKEY_BONES(3183, 5), MONKEY_BONES2(3179, 5), BAT_BONES(530, 5.3), BIG_BONES(532, 15), JOGRE_BONES(3125, 15), ZOGRE_BONES(4812, 12.5), SHAIKAHAN_BONES(3123, 25), BABY_DRAGON_BONES(534, 30), WYVERN_BONES(6812, 50), DRAGON_BONES(536, 72), FAYRG(4830, 84), RAURG_BONES(4832, 96), DAGANNOTH(6729, 125),
    OURG_BONES(4834, 140),
