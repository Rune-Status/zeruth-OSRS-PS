package org.arcanium.game.content.global.consumable;
...
public class Potion extends Drink {
	 ...
	 */
	private PotionEffect.Effect effect;
	 ...
	 */
	public Potion(Item item, ConsumableProperties properties, final PotionEffect.Effect effect, final Item... drinks) {
	 ...
	 */
	public Potion(Item item, final PotionEffect.Effect effect) {
	 ...
	 * @param effect the effect.
	 */
	public Potion(int item, final PotionEffect.Effect effect) {
	 ...
	 * @param effect the effect.
	 */
	public Potion(final PotionEffect.Effect effect) {
	 ...
	 * @return the effect.
	 */
	public PotionEffect.Effect getEffect() {
		return effect;
	}
	 ...
	 * @return the array.
	 */
	public static Item[] toDrinkArray(PotionEffect.Effect effect) {
