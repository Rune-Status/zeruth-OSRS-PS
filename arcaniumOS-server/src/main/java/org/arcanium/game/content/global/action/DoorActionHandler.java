...
import org.arcanium.game.node.object.Constructed;
import org.arcanium.game.node.object.GameObject;
import org.arcanium.game.node.object.ObjectBuilder;
import org.arcanium.game.system.task.LocationLogoutTask;
...
public final class DoorActionHandler {
    ...
    public static void handleDoor(final Player player, final GameObject object) {
        ...
        if (object.getDefinition().hasAction("close")) {
            ...
            DoorDefinitionsParser.Door d = DoorDefinitionsParser.forId(object.getId());
            if (d == null) {
        ...
        if (second != null) {
            DoorDefinitionsParser.Door s = DoorDefinitionsParser.forId(second.getId());
