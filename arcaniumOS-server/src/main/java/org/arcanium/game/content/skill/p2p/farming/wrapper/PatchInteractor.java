package org.arcanium.game.content.skill.p2p.farming.wrapper;
...
import org.arcanium.game.content.skill.p2p.farming.FarmingPatch;
import org.arcanium.game.content.skill.p2p.farming.patch.Allotments;
import org.arcanium.game.content.skill.p2p.farming.patch.Hops;
import org.arcanium.game.content.skill.p2p.farming.tool.PatchTool;
import org.arcanium.game.content.skill.p2p.farming.tool.ToolAction;
...
public final class PatchInteractor {
	...
	if (wrapper.getPatch() != null) {
	    ...
	    player.getConfigManager().sendVarp(965, 20 + (10 + ordinal - 10) * 1024);
	}
    }
