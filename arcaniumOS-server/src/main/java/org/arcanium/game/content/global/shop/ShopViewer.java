package org.arcanium.game.content.global.shop;
...
public final class ShopViewer {
     ...
     */
    public void update() {
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, -1, -2, 93, player.getInventory().toArray(), 28, false));
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, -1, -2, 92, shop.getContainer(0).toArray(), shop.getContainer(0).itemCount(), false));
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, -1, 64271, 31, shop.getContainer(1).toArray(), shop.getContainer(1).itemCount(), false));
    }
