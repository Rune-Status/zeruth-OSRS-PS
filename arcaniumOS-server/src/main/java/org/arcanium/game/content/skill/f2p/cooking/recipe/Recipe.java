package org.arcanium.game.content.skill.f2p.cooking.recipe;

import org.arcanium.game.content.skill.f2p.cooking.recipe.cake.ChocolateCake;
import org.arcanium.game.content.skill.f2p.cooking.recipe.pie.impl.*;
import org.arcanium.game.content.skill.f2p.cooking.recipe.pizza.impl.AnchovyPizza;
import org.arcanium.game.content.skill.f2p.cooking.recipe.pizza.impl.MeatPizza;
import org.arcanium.game.content.skill.f2p.cooking.recipe.pizza.impl.PineapplePizza;
import org.arcanium.game.content.skill.f2p.cooking.recipe.pizza.impl.PlainPizza;
import org.arcanium.game.content.skill.f2p.cooking.recipe.potato.impl.*;
import org.arcanium.game.content.skill.f2p.cooking.recipe.stew.CurryRecipe;
import org.arcanium.game.content.skill.f2p.cooking.recipe.stew.StewRecipe;
import org.arcanium.game.content.skill.f2p.cooking.recipe.topping.impl.*;
...
public abstract class Recipe {
    ...
    /**
     * Represents the array of active recipes in arcanium..
     */
