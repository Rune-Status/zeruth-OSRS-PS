...
import org.arcanium.game.content.global.quest.impl.free.RuneMysteries;
...
public class WhatLiesBelow extends Quest {
	...
	switch (stage) {
	case 0:
	    line("<blue>I can start this quest by speaking to <red>Rat Burgiss <blue>on the<n><blue>road south of <red>Varrock.<n><blue>Before I begin I will need to:<n>" + getReqMessage(), 4);
	    break;
	case 10:
	    line("<red>Rat<blue>, a trader in Varrock, has asked me to help him with a task.<n><blue>I need to kill <red>outlaws<blue> west of Varrock so that I can collect 5 of <n><blue>Rat's <red>papers<blue>.", 4);
	    break;
	case 20:
	    line("<red>Rat<blue>, a trader in Varrock, has asked me to help him with a task.<n><str>I need to kill outlaws west of Varrock so that I can collect<n><str>5 of Rat's papers.I have delivered Rat's folder to him. Perhaps I<n><str>should speak to him again.<n><blue>I need to deliver <red>Rat's<blue> letter to <red>Surok Magis<n><blue>in <red>Varrock.", 4);
	    break;
	case 30:
	case 40:
    ...
    public void finish() {
	super.finalize();
	player.getPacketDispatch().sendString("8,000 Runecrafting XP", 277, 8);
	player.getPacketDispatch().sendString("2,000 Defence XP", 277, 9);
	player.getPacketDispatch().sendString("Beacon Ring", 277, 10);
	player.getPacketDispatch().sendString("Knowledge of Chaos Tunnel", 277, 11);
	player.getPacketDispatch().sendString("You have completed What Lies Below!", 277, 2);
	player.getPacketDispatch().sendItemZoomOnInterface(BEACON_RING.getId(), 235, 277, 3);
