...
import org.arcanium.game.container.ContainerType;
...
public final class FarmingEquipment implements SavingModule {
	...
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, 125, 68, 91, new Container(21, first), true));
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, 125, 69, 91, new Container(21, second), true));
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, 126, 0, 91, new Container(21, first), true));
	PacketRepository.send(PartialContainerPacket.class, new ContainerContext(player, 126, 1, 91, new Container(21, second), true));
	update(player);
    }
	...
	player.getConfigManager().sendVarp(CONFIG, getConfigHash());
    }
