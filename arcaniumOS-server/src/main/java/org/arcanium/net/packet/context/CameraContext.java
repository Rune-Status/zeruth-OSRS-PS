...
public final class CameraContext implements Context {
     ...
     * bldr = new MessageBuilder(26); bldr.writeByte(y); //UPDATE_ZONE_FULL_FOLLOWS
     * bldr.writeByte(x); //UPDATE_ZONE_FULL_FOLLOWS bldr.writeLEShortA(z >>> 2); //UPDATE_ZONE_FULL_FOLLOWS
