...
import org.arcanium.game.node.entity.combat.handlers.RangeSwingHandler;
...
public final class SnapshotSpecialHandler extends RangeSwingHandler implements Plugin<Object> {
     ...
     */
    private static final Animation ANIMATION = new Animation(1074, Animator.Priority.HIGH);
