...
public final class KalphiteQueenNPC extends AbstractNPC {
     ...
     */
    private static final Animation TRANSFORM_ANIM = new Animation(6270, Animator.Priority.HIGH);
	...
	getAnimator().setPriority(Animator.Priority.LOW);
	 ...
	 */
	private static final Animation MELEE_ATTACK_1 = new Animation(6241, Animator.Priority.HIGH);

	/**
	 * The range/magic attack anim for the first form.
	 */
	private static final Animation RANGE_ATTACK_1 = new Animation(6240, Animator.Priority.HIGH);
	 ...
	 * The melee attack anim for the first form.
	 */
	private static final Animation MELEE_ATTACK_2 = new Animation(6235, Animator.Priority.HIGH);

	/**
	 * The range/magic attack anim for the first form.
	 */
	private static final Animation RANGE_ATTACK_2 = new Animation(6234, Animator.Priority.HIGH);
