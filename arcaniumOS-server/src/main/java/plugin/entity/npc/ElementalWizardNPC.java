...
public final class ElementalWizardNPC extends AbstractNPC {
    ...
    private void setSpell() {
        ...
        getProperties().setAutocastSpell((CombatSpell) SpellBookManager.SpellBook.MODERN.getSpell(spells[RandomFunction.random(spells.length)]));
    ...
    private void setBaseSpell() {
        getProperties().setAutocastSpell((CombatSpell) SpellBookManager.SpellBook.MODERN.getSpell(SPELLS[getSpellIndex()][0]));
    }
        ...
        public boolean handle(int interfaceId, int buttonId) {
            switch (stage) {
                ...
                case 20:
                    ...
                    break;
                case 21:
                    npc("Many say it was the greatest building in the history of", "Arcanium, a magnificent monument to human ingenuity.");
                    stage = 22;
                    break;
                case 22:
