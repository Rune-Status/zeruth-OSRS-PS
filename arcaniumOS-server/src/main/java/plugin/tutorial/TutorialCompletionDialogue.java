...
public class TutorialCompletionDialogue extends DialoguePlugin {
     ...
     */
    private static final Item[] STARTER_PACK = new Item[]{new Item(995, 75000), new Item(590, 1), new Item(303, 1), new Item(380, 20), new Item(1925, 1), new Item(1931, 1), new Item(8007, 3), new Item(8010, 3), new Item(4447, 1), new Item(2741, 1), new Item(14775, 1)};
        ...
        if (npc.getId() == 2796 || TutorialSession.getExtension(player).getStage() >= 71) {
            switch (stage) {
                ...
                case 520:
                    ...
                    player.getProperties().setTeleportLocation(new Location(2100, 3914));
                    ...
                    player.getPacketDispatch().sendMessages("<img=16><col=6600CC>As a new player, you are receiving boosted combat skill experience.</col>", "<col=6600CC>We highly recommend playing in high-detail mode if your machine can support it.</col>", "<col=6600CC>Please join the clan chat 'life'.");
                    player.sendMessage("<col=6600CC>Use the teleporter for easy access to training,cities and minigames.");
                    Repository.sendNews("<col=ff0000>Everyone Welcome " + player.getUsername() + " to Vernox!");
                    //player.clanManager.getClan("life");
