        ...
        if (tut_stage < TutorialSession.MAX_STAGE) {
            ...
            switch (stage) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    interpreter.sendDialogues(npc, null, "First of all, you may use ::Commands", "to find useful commands and teleports.", "Travelling in " + GameWorld.getName() + " is all handled through commands");
                    stage = 20;
                    break;
                case 20:
