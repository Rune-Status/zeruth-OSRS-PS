...
import org.arcanium.game.content.dialogue.book.Book;
import org.arcanium.game.content.dialogue.book.BookLine;
import org.arcanium.game.content.dialogue.book.Page;
import org.arcanium.game.content.dialogue.book.PageSet;
...
public final class TutorialBook extends Book {
    ...
    private static final PageSet[] PAGES = new PageSet[]{
            ...
            new PageSet(
                    new Page(
                            ...
                            new BookLine("www.Vernox.org.", 59), new BookLine("We wholeheartedly look over", 60), new BookLine("and consider all suggestions.", 61))),
    ...
    public TutorialBook(final Player player) {
        super(player, "Arcanium Starter Book", 1856, PAGES);
    }
